# NeuroAIComparison Theme System Overview
...
| Persistence        | LocalStorage load/save keyed by `neuroaicomparison:theme`                                 | `loadTheme`, `saveTheme`                  |
...
| Persistent old theme    | LocalStorage stale/corrupt       | Clear `localStorage['neuroaicomparison:theme']`                          |
